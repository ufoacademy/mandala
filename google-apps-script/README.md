...
1. 리드를 저장할 새 Google Sheets 문서를 만듭니다. 첫 행에 헤더를 넣어둡니다: `날짜 | 이름 | 나이 | 성별 | 이메일 | 연락처 | 총점`
...
curl -X POST "여기에_배포된_웹앱_URL" \
  ...
  -d '{"timestamp":"2026-07-10T00:00:00.000Z","name":"테스트","age":"35","gender":"f","contact":"010-0000-0000","email":"test@example.com","totalScore":160}'
```
